...
namespace curso.test.Integrations.Controllers
{
    public class CursoControllerTests : UsuarioControllerTests
    {
        ...
        {
            // Arrange
            var cursoViewModelInput = new AutoFaker<CursoViewModelInput>(AutoBogusConfiguration.LOCATE);
            ...
            // Act
            _httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", UsuarioViewModelOutput.Token);
